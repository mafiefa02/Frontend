  ...
  return (
    <div className="App">
      ...
      <div className="flex min-w-screen min-h-screen bg-lightGray justify-center items-center">
        <div className="flex-col rounded-[13px] bg-white min-h-[21em] min-w-[14em] justify-center items-start">
          <div className="flex rounded-[13px] max-h-[15em] max-w-[14em] p-3 overflow-hidden">
